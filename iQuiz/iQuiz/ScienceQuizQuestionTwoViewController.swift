//
//  ScienceQuizQuestionTwoViewController.swift
//  iQuiz
//
...
class ScienceQuizQuestionTwoViewController: UIViewController {

    @IBOutlet weak var collectionView: UICollectionView!
    @IBOutlet weak var nextButton: UIButton!

    let answers = ["56", "22", "79", "104"]
    var isCorrect = false
    var score = 0
    var currentScore = 0
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let destVC = segue.destination as? ScienceQuizAnswerTwoViewController {
            
            let selectedAnswer = isCorrect ? "You are Correct!" : "You are Wrong!"
            let correctAnswer = "Answer: 79"
...
extension ScienceQuizQuestionTwoViewController: UICollectionViewDelegate {
...
extension ScienceQuizQuestionTwoViewController: UICollectionViewDataSource {
